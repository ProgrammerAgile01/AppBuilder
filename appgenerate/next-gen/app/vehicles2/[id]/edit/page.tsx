...
function EditVehicleContent() {
  ...
  useEffect(() => {
    ...
    if (foundVehicle) {
      ...
      setFormData({
        ...
        seats: foundVehicle.seats.toString(),
        dailyRate: foundVehicle.dailyRate.toString(),
        ...
        images: {
          front: foundVehicle.images[0],
          side: foundVehicle.images[1],
          back: foundVehicle.images[2],
          additional: foundVehicle.images.slice(3) || [],
        },
      })
    }
    setLoading(false)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect back to vehicle detail
      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator className="hidden md:block" />
            <BreadcrumbItem className="hidden md:block">
              <BreadcrumbLink href={`/vehicles/${vehicle.id}`} className="text-muted-foreground hover:text-foreground">
                {vehicle.brand} {vehicle.model}
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator className="hidden md:block" />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-foreground">Edit Vehicle</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Update information for {vehicle.brand} {vehicle.model} ({vehicle.plateNumber})
            </p>
          </div>
        </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Update photos of your vehicle from different angles for better visibility
              </p>
            </CardHeader>
            <CardContent>
