...
//         try {
//             if (mode === "create") {
//                 await createData("vehicles", formData);
//                 toast({ title: "Berhasil!", description: "Vehicle berhasil dibuat"})
//             } else {
//                 await updateData("vehicles", formData.id!, formData)
//                 toast({
//                     title: "Berhasil!",
...
export function VehicleForm({
  ...
  const buildPayload = () => {
    const payload: any = {
      ...
      number_of_seats: formData.number_of_seats ?? undefined,
    ...
    if (formData.front_photo instanceof File)
      payload.front_photo = formData.front_photo;
    if (formData.side_photo instanceof File)
      payload.side_photo = formData.side_photo;
    if (formData.back_photo instanceof File)
      payload.back_photo = formData.back_photo;
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">
                {mode === "create"
                  ? "Add New Vehicle Management"
                  : "Edit Vehicle Management"}
              </h1>
              <p className="text-muted_foreground">
                {mode === "create"
                  ? "Add Information for Vehicle Management"
                  : "Update Information for Vehicle Management"}
              </p>
            </div>
          </div>
