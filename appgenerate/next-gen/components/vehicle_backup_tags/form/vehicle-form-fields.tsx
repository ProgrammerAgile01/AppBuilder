...
export function VehicleFormFields({
  ...
  const normalizeFeatures = (v: any): string[] =>
  ...
  const handleAddFeature = () => {
    ...
    const curr = normalizeFeatures(formData?.features);
    if (curr.some((t) => t.toLowerCase() === v.toLowerCase())) return;

    setFormData((prev) => ({
      ...prev,
      features: [...normalizeFeatures(prev?.features), v],
    }));
    setNewFeature("");
  };
  ...
  const handleRemoveFeature = (feature: string) => {
    setFormData((prev) => ({
      ...prev,
      features: normalizeFeatures(prev?.features).filter((f) => f !== feature),
    }));
  };

  const features = normalizeFeatures(formData?.features);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <Label htmlFor="plate_number" className="text-foreground">
                Plate Number*
              </Label>
              <Input
                type="text"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <Label htmlFor="fuel_type" className="text-foreground">
                Fuel Type*
              </Label>
              <Select
                value={formData.fuel_type || ""}
                onValueChange={(val) =>
                  setFormData((prev) => ({ ...prev, fuel_type: val }))
                }
                required
              >
                <SelectTrigger>
            ...
            <div className="space-y-1">
              <Label htmlFor="number_of_seats" className="text-foreground">
                Number Of Seats*
              </Label>
              <Input
                type="number"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <Label htmlFor="daily_rate" className="text-foreground">
                Daily Rate (Idr)*
              </Label>
              <Input
                type="number"
