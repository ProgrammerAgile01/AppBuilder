...
import { PelangganHeader, PelangganFilters, PelangganTable, ResultsInfo } from "./pelanggan-page-contents";
...
export function PelangganPage() {
    ...
    const paginatedItems = filteredPelanggan.slice(startIndex, startIndex + ITEMS_PER_PAGE);

    const handleDelete = async (id: string) => {
        try {
            await deleteData("pelanggans", id);
            toast({ title: "Berhasil!", description: "Data Pelanggan berhasil dihapus." });
                ...
                <SidebarInset>
                    ...
                    <div className="flex flex-1 flex-col">
                        <div className="space-y-6 p-4">
                            ...
                            <PelangganFilters searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
                            <ResultsInfo total={filteredPelanggan.length} currentPage={currentPage} itemsPerPage={ITEMS_PER_PAGE} />
                            <PelangganTable handleView={handleView} handleDelete={handleDelete} filteredPelanggan={filteredPelanggan} />
                        </div>
                    </div>
                </SidebarInset>
            </SidebarProvider>
    ...
    // return <PelangganContents items={items} loading={loading} stats={stats} />;
}