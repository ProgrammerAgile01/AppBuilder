...
[{ id: "kendaraan", icon: Car, labelKey: "Kendaraan" as any, description: "Manage Vehicle Module", descriptionId: "Manage Vehicle Module", count: 1, items: [{ icon: Truck, labelKey: "Vehicle Management" as any, href: "/vehicle-manajement" }], groupId: "1", groupName: "Operasional", groupColor: "#8b5cf6", iconBg: "bg-primary/15", iconColor: "text-primary", activeBorder: "border-primary/40", borderColor: "border-border", hoverBorder: "hover:border-primary/30" },{ id: "laporan-keuangan", icon: FileSpreadsheet, labelKey: "Laporan Keuangan" as any, description: "Manage Financial Report", descriptionId: "Manage Financial Report", count: 1, items: [{ icon: FileText, labelKey: "Laporan Harian" as any, href: "/laporan-harian" }], groupId: "5", groupName: "Laporan", groupColor: "#10b981", iconBg: "bg-primary/15", iconColor: "text-primary", activeBorder: "border-primary/40", borderColor: "border-border", hoverBorder: "hover:border-primary/30" }];
/*======================================================================*/
