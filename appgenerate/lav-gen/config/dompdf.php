...
return [
    ...
    */
    ...
    'options' => [
        ...
        'fonts' => [
            // DomPDF hanya mengenal 4 style: normal, bold, italic, bold_italic
            'poppins' => [
                'normal'      => storage_path('fonts/Poppins-Regular.ttf'),
                'bold'        => storage_path('fonts/Poppins-Bold.ttf'),
                'italic'      => storage_path('fonts/Poppins-Italic.ttf'),       // kalau tidak ada, sementara pakai Regular
                'bold_italic' => storage_path('fonts/Poppins-BoldItalic.ttf'),   // kalau tidak ada, sementara pakai Bold
            ],
        ],
