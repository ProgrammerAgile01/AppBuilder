        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-lg">
              <Image src="/rentvix-logo.png" alt="RentVix Pro" width={32} height={32} className="rounded-lg" />
            </div>
          </div>
          <h1 className="text-2xl font-bold text-foreground mb-2">RentVix Pro</h1>
          <p className="text-muted-foreground text-sm">Sistem Manajemen Rental Kendaraan Profesional</p>
        </div>
              ...
              <div className="bg-muted/30 rounded-lg p-3 border border-border/50">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-sm text-foreground">{companyInfo.name}</p>
            ...
            {currentStep === "company" ? (
              ...
              <div className="space-y-4">
                ...
                <Tabs value={authMethod} onValueChange={(value) => setAuthMethod(value as AuthMethod)}>
                  ...
                  <TabsContent value="otp" className="space-y-4 mt-4">
                    <div className="space-y-2">
                      <Label htmlFor="company-otp" className="text-sm font-medium">
                        Kode OTP
                      </Label>
              ...
              <div className="space-y-4">
                ...
                <Tabs value={authMethod} onValueChange={(value) => setAuthMethod(value as AuthMethod)}>
                  ...
                  <TabsContent value="otp" className="space-y-4 mt-4">
                    <div className="space-y-2">
                      <Label htmlFor="user-otp" className="text-sm font-medium">
                        Kode OTP
                      </Label>
                      <div className="flex space-x-2">
                        <div className="relative flex-1">
