...
const menuItems: any =
[{ id: "data-operational", icon: Settings, labelKey: "Data Operational" as any, description: "Manage Data Operasional", descriptionId: "Manage Data Operasional", count: 1, items: [{ icon: Car, labelKey: "Data Kendaraan" as any, href: "/data-kendaraan" }], groupId: "1", groupName: "Operasional", groupColor: "#14b8a6", iconBg: "bg-primary/15", iconColor: "text-primary", activeBorder: "border-primary/40", borderColor: "border-border", hoverBorder: "hover:border-primary/30" }];
/*======================================================================*/
