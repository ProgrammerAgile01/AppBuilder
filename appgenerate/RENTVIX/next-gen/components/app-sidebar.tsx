...
export const menuItems = [
  {
    ...
    items: [
      ...
      {
        icon: Calendar,
        labelKey: "rentalSchedule" as const,
        href: "/schedule",
      },
      {
        icon: FileText,
        labelKey: "digitalContract" as const,
        href: "/contracts",
      },
      {
        icon: ArrowRightLeft,
        labelKey: "vehicleHandover" as const,
        href: "/handover",
      },
      { icon: RotateCcw, labelKey: "vehicleReturn" as const, href: "/returns" },
      {
        icon: CreditCard,
        labelKey: "invoicePayment" as const,
        href: "/invoices",
      },
    ],
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-950/50 dark:to-green-900/50",
    ...
    items: [
      ...
      {
        icon: Calendar,
        labelKey: "maintenanceSchedule" as const,
        href: "/maintenance/schedule",
      },
      {
        icon: History,
        labelKey: "maintenanceHistory" as const,
        href: "/maintenance/history",
      },
      { icon: UserCheck, labelKey: "driverCrew" as const, href: "/drivers" },
      {
        icon: Wallet,
        labelKey: "driverAllowance" as const,
        href: "/driver-allowance",
      },
      {
        icon: Fuel,
        labelKey: "fuelMonitoring" as const,
  ...
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-950/50 dark:to-purple-900/50",
    ...
    items: [
      {
        icon: TrendingUp,
        labelKey: "transactionReports" as const,
        href: "/reports/transactions",
      },
      {
        icon: Car,
        labelKey: "vehicleUsageReports" as const,
        href: "/reports/usage",
      },
      {
        icon: DollarSign,
        labelKey: "financialReports" as const,
        href: "/reports/financial",
      },
      {
        icon: PieChart,
        labelKey: "profitLossPerUnit" as const,
        href: "/reports/profit-loss",
      },
      {
        icon: Activity,
        labelKey: "fleetKpiStats" as const,
        href: "/reports/kpi",
      },
    ],
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-indigo-950/50 dark:to-blue-900/50",
        ...
        items: [
          {
            icon: IdCard,
            label: "Jenis SIM",
            href: "/master-data/license-types",
          },
          {
            icon: Star,
            label: "Level Driver",
            href: "/master-data/driver-levels",
          },
        ],
      },
      {
        ...
        items: [
          {
            icon: Wallet,
            label: "Kategori Kas",
            href: "/master-data/cash-categories",
          },
  ...
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-slate-50 to-gray-100 dark:from-slate-950/50 dark:to-gray-900/50",
    ...
    items: [
      ...
      {
        icon: Lock,
        labelKey: "accessControl" as const,
  ...
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-950/50 dark:to-orange-900/50",
    ...
    items: [
      {
        icon: Receipt,
        labelKey: "rentalPricing" as const,
        href: "/settings/pricing",
      },
      {
        icon: Shield,
        labelKey: "accessRights" as const,
        href: "/settings/access",
      },
      {
        icon: MessageSquare,
        labelKey: "whatsappSender" as const,
        href: "/settings/whatsapp",
      },
      {
        icon: Bell,
        labelKey: "remindersNotifications" as const,
        href: "/settings/notifications",
      },
      {
        icon: FileText,
        labelKey: "contractTemplates" as const,
  ...
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-rose-50 to-pink-100 dark:from-rose-950/50 dark:to-pink-900/50",
    ...
    items: [
      ...
      {
        icon: LogIn,
        labelKey: "customerLogin" as const,
        href: "/customers/login",
      },
      {
        icon: History,
        labelKey: "bookingHistory" as const,
        href: "/customers/history",
      },
      {
        icon: Gift,
        labelKey: "couponsRewards" as const,
  ...
  },
  {
    ...
    iconBg:
      "bg-gradient-to-br from-teal-50 to-cyan-100 dark:from-teal-950/50 dark:to-cyan-900/50",
    ...
    items: [
      {
        icon: BookOpen,
        labelKey: "manualBook" as const,
        href: "/support/manual",
      },
      { icon: HelpCircle, labelKey: "faq" as const, href: "/support/faq" },
      {
        icon: Video,
        labelKey: "tutorialVideos" as const,
  ...
  useEffect(() => {
    ...
    if (pathname.startsWith("/customers")) {
      ...
      for (const module of menuItems) {
        if (module.items) {
          const isInModule = module.items.some((item) =>
                      ...
                      <>
                        ...
                        <ChevronDown
                          className={`h-4 w-4 transition-transform duration-200 ${
                            expandedNestedItems.includes(nestedItem.id)
                              ? "rotate-180"
                              : ""
                          }`}
                        />
    ...
    <div className="flex flex-col h-full bg-background text-foreground">
      <SidebarHeader className="border-b border-border/50 p-4 bg-gradient-to-r from-muted/30 to-muted/10 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          {(!isMobile || state === "expanded") && (
            <div>
              <h2 className="text-base font-bold text-foreground font-space-grotesk tracking-tight">
                RentVix
              </h2>
...
export function AppSidebar() {
  return (
    <Sidebar
      variant="inset"
      className="border-r border-border/50 bg-background text-foreground"
    >
