...
interface DataCustomerTrashProps {
  onClose: () => void;
}

export function DataCustomerTrash({ onClose }: DataCustomerTrashProps) {
    ...
    const col1 = "nama_lengkap";
    const col1Label = "Nama Lengkap";
    const col2 = "alamat";
    const col2Label = "Alamat";
    ...
    const fetchDeletedData = async (showRefreshing = false) => {
        try {
            ...
            const response = await deletedDataAPI("data-customers");
    ...
    const handleRestore = async (id: string) => {
        try {
            await restore("data-customers", id);
            toast({
                title: "Success!",
            ...
            toast({
                title: "Error",
                description: "Failed restore data",
                variant: "destructive",
            });
        } finally {
    ...
    const handlePermanentDelete = async (id: string) => {
        try {
            await forceDelete("data-customers", id);
            toast({
                title: "Success!",
                description: "Successfully deleted this data permanently",
            });
            fetchDeletedData();
        } catch (error) {
            toast({
                title: "Error",
                description:
                "Failed to permanently delete data. Please try again.",
                variant: "destructive",
            });
        } finally {
                    ...
                    {deletedData.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-16">
                            ...
                            <p className="text-slate-600 text-center max-w-md">
                                ...
                                : "No data has been deleted yet. Deleted data will appear here."}
                            </p>
                        </div>
                    ) : (
                                                    ...
                                                    <AlertDialog open={restoreDialogOpen} onOpenChange={setRestoreDialogOpen}>
                                                        <AlertDialogContent>
                                                            <AlertDialogHeader>
                                                                ...
                                                                <AlertDialogDescription>
                                                                    Are you sure to restore this data?
                                                                </AlertDialogDescription>
                                                            </AlertDialogHeader>
                                                            <AlertDialogFooter>
                                                        ...
                                                        <AlertDialogContent>
                                                            <AlertDialogHeader>
                                                                ...
                                                                <AlertDialogDescription className="space-y-2">
                                                                    <p>
                                                                        <strong className="text-red-600">WARNING:</strong> You will delete this data permanently.
                                                                    </p>
                                                                    <p>
                                                                        This action <strong>CANNOT BE UNDONE</strong> and will delete associated data
                                                                    </p>
                                                                </AlertDialogDescription>
                                                            </AlertDialogHeader>
                                                            <AlertDialogFooter>
