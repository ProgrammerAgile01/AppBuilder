...
import { DataCustomerTrash } from "./data-customer-trash";
...
export function DataCustomerPage() {
    ...
    const fetchDeletedCount = async() => {
        try {
            const response = await deletedData("data-customers");
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            toast({ title: "Success!", description: "Data Moved To Trash." });
            ...
            <div className="flex flex-1 flex-col">
                <div className="space-y-6 p-4">
                    <div className="flex items-center justify-between gap-3">
                        <DataCustomerHeader onAdd={handleAdd} onOpenTrash={openTrash} deletedCount={deletedCount} />
