...
import {
  ...
  DataCustomerTable,
  ResultsInfo,
} from "./data-customer-page-contents";
...
export function DataCustomerPage() {
  ...
  const filteredDataCustomer = useMemo(() => {
    ...
    const SEARCH_KEYS = ["namaLengkap", "alamat"] as const;
  ...
  const paginatedItems = filteredDataCustomer.slice(
    startIndex,
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      toast({
        title: "Berhasil!",
        description: "Data DataCustomer berhasil dihapus.",
      });
  ...
  const CRUMBS = [
    { title: "Master Data", route_path: null, level: 1, type: "group" },
    { title: "Customer", route_path: null, level: 2, type: "module" },
    {
      title: "Data Customer",
    ...
    <>
      ...
      <div className="flex flex-1 flex-col">
        <div className="space-y-6 p-4">
          ...
          />
          <ResultsInfo
            total={filteredDataCustomer.length}
