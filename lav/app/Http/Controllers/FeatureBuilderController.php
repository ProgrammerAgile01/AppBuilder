    ...
    public function generate(string $product): JsonResponse
{
    ...
    try {
        ...
        $baseGen = base_path('../appgenerate/RENTVIX/lav-gen');
    ...
    {
        $destDir = base_path('../appgenerate/RENTVIX/lav-gen/database/migrations');
...
PHP;
    ...
    {
        $dest = base_path('../appgenerate/RENTVIX/lav-gen/app/Models/FeatureBuilder.php');
...
PHP;
    ...
    {
        $dest = base_path('../appgenerate/RENTVIX/lav-gen/app/Http/Controllers/Generate/FeatureBuilderController.php');
        if (File::exists($dest)) return;
...
PHP;
    ...
    {
        $apiFile = base_path('../appgenerate/RENTVIX/lav-gen/routes/api.php');
...
PHP;
        ...
        $path = base_path('../appgenerate/RENTVIX/lav-gen/database/seeders/' . $className . '.php');
